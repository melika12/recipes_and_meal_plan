...
//accept requested recipe
if (isset($_GET['recipeid'])) {
    acceptRequestedRecipe($_GET['recipeid']);
...
//accept requested ingredient
if (isset($_GET['ingredientid'])) {
    acceptRequestedIngredient($_GET['ingredientid']);

    header('Location: ../pages/requests.php');
    exit();
}

//edit and save requested ingredient
if (isset($_POST['request_ingredient'])) {
    saveRequestedIngredient($_POST['ingredient_id'], $_POST['ingredient']);
...
//accept requested unit
if (isset($_GET['unitid'])) {
    acceptRequestedUnit($_GET['unitid']);

    header('Location: ../pages/requests.php');
    exit();
}

//edit and save requested unit
if (isset($_POST['request_unit'])) {
    saveRequestedUnit($_POST['unit_id'], $_POST['unit']);
